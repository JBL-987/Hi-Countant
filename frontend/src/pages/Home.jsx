...
export default function Home({ isAuthenticated }) {
  ...
  return (
    <div ref={vantaRef} className="bg-black text-white">
      {/* Hero Section */}
      <section className="min-h-screen flex flex-col justify-center items-center p-4 pt-16">
        <div className="max-w-5xl text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-300 max-w-3xl mx-auto">
            Hi! Countant replaces traditional accountants with powerful AI that
            handles all your financial needs securely on the blockchain.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg text-lg font-medium hover:opacity-90 transition-all transform hover:scale-105">
              Get Started
            </button>
            <button className="px-8 py-3 bg-transparent border border-white/30 rounded-lg text-lg font-medium hover:bg-white/10 transition-all">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section
        id="benefits"
        className="py-20 px-4 bg-gradient-to-b from-black to-blue-950"
      >
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-t from-black to-blue-950">
